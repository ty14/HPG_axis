...
saveRDS(v.dl, "females/clean_data/limma_vdl_PIT.RDS")
...
saveRDS(q.dl,("females/clean_data/limma_vdl_eFDRcutoffs_PIT.RDS"))

q.dl <- readRDS("females/clean_data/limma_vdl_eFDRcutoffs_PIT.RDS")
...
saveRDS(bvo,"females/clean_data/limma_eFDR_PIT.RDS")

fe_bvo <- readRDS("females/clean_data/limma_eFDR_PIT.RDS") 
